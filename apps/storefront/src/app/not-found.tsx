...
export default function NotFound() {
  return (
    <div className="items-center flex justify-center  min-h-[100vh] bg-gradient-to-b from-[rgba(34,13,55,255)] to-[rgba(21,13,56,255)]">
      <div className="rounded-[15px] bg-gradient-to-b from-[#9C52F2] to-[#4C52FB] p-[1px] w-[920px] h-[770px]">
